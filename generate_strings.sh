...
find SecureOSX -name '*.m' | xargs genstrings -o SecureOSX/en.lproj
iconv -f UTF-16 -t UTF-8 SecureOSX/en.lproj/Localizable.strings > SecureOSX/en.lproj/Localizable.strings.8
mv SecureOSX/en.lproj/Localizable.strings.8 SecureOSX/en.lproj/Localizable.strings

# generate strings from XIBs

for file in `find SecureOSX -name '*.xib' -and -path '*/en.lproj/*'`; do
